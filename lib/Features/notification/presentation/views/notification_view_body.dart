...
class notification_view_Body extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        SizedBox(height: 18),
        Text("Order & Delivery Updates", style: AppStyles.font16SemiBold),
        SizedBox(height: 8),
        OrderDeliveryNotificationSection(notificationEntity: order_Delivery_Entity,),
        SizedBox(height: 12),
        Text("Deals & Promotions", style: AppStyles.font16SemiBold),
        SizedBox(height: 8),
        DealsPromotionsNotificationSection(notificationEntity:Deals_promotions_Entity ,),
        Text("Account & Reminders", style: AppStyles.font16SemiBold),
