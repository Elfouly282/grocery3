    ...
    return BlocConsumer<CartCubit, CartState>(
      ...
      builder: (context, state) {
        ...
        final updatingItemId =
            state is CartItemUpdating ? (state).updatingItemId : null;
        final removingItemId =
            state is CartItemRemoving ? (state).removingItemId : null;
                  ...
                  children: [
                    ...
                    CustomButton(
                      ...
                      onPressed: () {
                        ...
                        customSnakebar(context, 'Proceeding to checkout...', Colors.green);
                      },
                    ),
                  ],
                ),
